...
> **Re-subjected (v0.0.4).** The previous flagship promoted hve-video-director itself — a UI-less
...
|------|----------|-----------|
| 2026-06-24 | Re-subject flagship to blog.nebrass.fr | hve-video-director has no UI to film; a real app puts the product on screen (fixes the flat "shapes and text" reference build) |
