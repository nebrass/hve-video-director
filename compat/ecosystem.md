...
| Symbol | Owning skill | Skill-relative path | What it is | Used by |
|---|---|---|---|---|
| `TRANSITION_CATALOG` | `hyperframes-animation` | `transitions/catalog.md` | Hard rules + scene template + shader rules for transitions — the normative page | `patterns/transition-catalog.md` § Hard rules; Phase 4 Step 4.5 |
