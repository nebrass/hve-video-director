...
This hosted video predates both the current blog reference build and the v0.1.0 rename — it
still shows the former `hve-spielberg` branding, and it is not regenerated by `example/`.
