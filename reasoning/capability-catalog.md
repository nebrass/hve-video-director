...
Stage 14 of the reasoning pipeline. Consumed by Phase 1 (scene planning) and re-checked in
Phase 3 (scene direction). The director reasons in **communication capabilities**, never in
